...
export default class Approve extends React.Component {
  constructor() {
    ...
    const ds = {
      ...
      cardData: [
        ...
        },
        {
          ...
          Status: 'Open',
          Summary:
            'Arrange web meeting with customer to get editing requirements',
          Priority: 'Critical',
      ...
      kanbanPizzaData: [
        ...
        },
        {
          ...
          Description:
            "It's made using toppings of tomato, mozzarella cheese and fresh basil, which represent the red, white and green of the Italian flag.",
          Tags: 'Onions, Pepper, Cheese',
    ...
    this.data = extend([], ds.cardData, null, true);
    this.fields = [
      ...
      <div className={'card-template ' + props.Priority}>
        ...
        <div className='e-card-footer'>
          {props.Tags.split(',').map((tag) => (
            <div className='e-card-tag e-tooltip-text'>{tag}</div>
          ))}
